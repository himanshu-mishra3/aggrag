...
from library.aggrag.aggrag_base_abstract import AggragBaseAbstract  # Import the abstract base class

class SubQA(AggragBaseAbstract):  # Inherit from the abstract base class
    def __init__(self,
                 usecase_name: str,
                 iteration: str,
        ...
        self.name = 'subqa'
        self.ai_service = subqa_rag_setting.ai_service
        self.chunk_size = subqa_rag_setting.chunk_size
        self.subqa_rag_setting=subqa_rag_setting

        # self.system_prompt = subqa_rag_setting.system_prompt
        # self.context_prompt = subqa_rag_setting.context_prompt
        self.llm = llm
        self.embed_model = embed_model
        self.documents = None
        self.index_name = subqa_rag_setting.index_name or "subqa_index"
        self.index = None
