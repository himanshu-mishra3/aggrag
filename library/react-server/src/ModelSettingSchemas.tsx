/**
 * A place to put all models supported by Aggrag and their
  ...
  schema: {
    ...
    properties: {
      ...
      temperature: {
        ...
        title: "temperature",
        description:
          "Controls the randomness of the output. Must be positive. Typical values are in the range: [0.0, 1.0]. Higher values produce a more random and varied response. A temperature of zero will be deterministic. (Aggrag only allows a max 1.0 temperature for PaLM).",
        default: 0.5,
        minimum: 0,
        maximum: 1,
        multipleOf: 0.01,
...
const DalaiModelSettings: ModelSettingsDict = {
  ...
  schema: {
    ...
    properties: {
      ...
      threads: {
        ...
        title: "threads",
        description:
          "The number of threads to use on the local machine. Defaults to 4 in Aggrag, to support lower-end laptops. Set to higher the more powerful your machine.",
        minimum: 1,
        default: 4,
      },
      top_k: {
  ...
  uiSchema: {
    ...
    model: {
      "ui:help":
        "NOTE: You must have installed the selected model and have Dalai be running and accessible on the local environment with which you are running the Aggrag server.",
    },
    temperature: {
      "ui:help": "Defaults to 0.5.",
      "ui:widget": "range",
...
const HuggingFaceTextInferenceSettings: ModelSettingsDict = {
  ...
  schema: {
    ...
    properties: {
      ...
      num_continuations: {
        type: "integer",
        title: "Number of times to continue generation (Aggrag-specific)",
        description:
  ...
  uiSchema: {
    ...
    use_cache: {
      "ui:widget": "radio",
      "ui:help":
        "Defaults to false in Aggrag. This differs from the HuggingFace docs, as CF's intended use case is evaluation, and for evaluation we want different responses each query.",
    },
  },
    ...
    properties: {
      ...
      custom_prompt_wrapper: {
        ...
        description:
          ...
          'Anthropic models expect prompts in the form "\\n\\nHuman: ${prompt}\\n\\nAssistant:". Aggrag wraps all prompts in this template by default. If you wish to' +
          // eslint-disable-next-line no-template-curly-in-string
  ...
  schema: {
    ...
    properties: {
      ...
      system_prompt: {
        ...
        description: "The system prompt to be used in RAG.",
        title: "System Prompt",
        type: "string",
      },
      temperature: {
...
const SubQARagSettings: ModelSettingsDict = {
  fullName: "SubQA",
  schema: {
    type: "object",
    required: ["shortname"],
    properties: {
      ...
      INDEX_TEXT_QA_SYSTEM_PROMPT_CONTENT: {
        ...
        description: "Refer default prompt for more reference",
        title: "INDEX TEXT QA SYSTEM PROMPT CONTENT",
        type: "string",
      },
      ...
      SUBQ_TEXT_QA_SYSTEM_PROMPT_CONTENT: {
        ...
        title: "SUBQ TEXT QA SYSTEM PROMPT CONTENT",
        type: "string",
      },
      ai_service: {
        default: "AzureOpenAI",
...
const RaptorRagSettings: ModelSettingsDict = {
  fullName: "Raptor",
  schema: {
    type: "object",
    required: ["shortname"],
    properties: {
      ...
      summary_prompt: {
        ...
        description: "The summary prompt to be used.",
...
const Meta_llamaRagSettings: ModelSettingsDict = {
  fullName: "Meta_llama",
  schema: {
    type: "object",
    required: ["shortname"],
...
const Meta_langRagSettings: ModelSettingsDict = {
  fullName: "Meta_lang",
  schema: {
    type: "object",
    required: ["shortname"],
    properties: {
      ...
      metadata_json_schema: {
        default: "",
        description: "The metadata json schema used for metadata extraction",
        title: "metadata json schema",
        type: "string",
      },
      temperature: {
...
const Table_baseRagSettings: ModelSettingsDict = {
  ...
  schema: {
    ...
    properties: {
      ...
      engine_prompt: {
        default: "",
        description: "The engine prompt to be used in RAG.",
        title: "Engine Prompt",
        type: "string",
      },
      temperature: {
 ...
 * Processes settings values to the correct types according to schema for the model 'llm'.
 * @param {*} settings_dict A dict of form setting_name: value (string: string)
 * @param {*} rag A string of the name of the model to query.
 */
export function typecastRagSettingsDict(
  settings_dict: ModelSettingsDict,
  rag: string,
) {
  const settings = getSettingsSchemaForRAG(rag);
  const schema = settings?.schema?.properties ?? {};
  const postprocessors = settings?.postprocessors ?? {};
...
export const setCustomProvider = (
  ...
  console.log("Schema: ", compiled_schema);
};
